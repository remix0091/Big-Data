...
object HourlyTipsExercise {
  ...
  class AddTips extends ProcessWindowFunction[
    com.ververica.flinktraining.exercises.datastream_java.datatypes.TaxiFare,
    (Long, Long, Float),
    Long,
    TimeWindow] {
    ...
    override def process(
                          key: Long,
                          context: Context,
                          elements: Iterable[com.ververica.flinktraining.exercises.datastream_java.datatypes.TaxiFare],
